...
INSERT INTO `items` VALUES (1,'i00001','訂金',0,'非加購項目'),(2,'i00002','兒童安全座椅',100,'加購項目'),(3,'i00003','升級保險',400,'加購項目'),(4,'i00004','行車紀錄器',100,'加購項目'),(5,'i00005','調度費',0,'非加購項目'),(6,'i00006','尾款',0,'非加購項目');
